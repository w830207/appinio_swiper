...
class _AppinioSwiperState extends State<AppinioSwiper>
  ...
  void _swipeHorizontal(BuildContext context, bool? toRight) {
    setState(() {
      _swipeTyp = 1;
...
class AppinioSwiperController extends ChangeNotifier {
  ...
  void pressToLeft() {
    pressState = AppinioSwiperState.toLeft;
    notifyListeners();
    pressState = null;
  }

  void pressToRight() {
    pressState = AppinioSwiperState.toRight;
    notifyListeners();
    pressState = null;
  }
}

enum AppinioSwiperState { unswipe, toLeft, toRight }
